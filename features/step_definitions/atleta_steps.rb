...
Given(/^o sistema tenha o atleta com o cpf "([^"]*)"$/) do |cpf|
  @retorno = Atletas.new("nome", "email", "telefone", "data_nascimento", cpf, "rg", "altura", "peso", "posicao_joga", "categoria", "alojamento_clube")
  @retorno.should_not eq(nil)
end

When(/^eu modifico os dados do atleta com o cpf "([^"]*)"$/) do |cpf|
  atleta = Atletas.find_cpf(cpf)
  #atleta.nome = "Carmem"
end
