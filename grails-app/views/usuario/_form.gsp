...
<div class=" form-group ${hasErrors(bean: usuarioInstance, field: 'nome', 'error')} required">
	...
	<div class="col-md-10">
		<g:textField class="form-control" placeholder="Nome" name="nome" required="" value="${usuarioInstance?.nome}"/>
	</div>
</div>
...
<div class="form-group ${hasErrors(bean: usuarioInstance, field: 'email', 'error')} required">
	...
	<div class="col-md-10">
		<g:field class="form-control" placeholder="Email" type="email" name="email" required="" value="${usuarioInstance?.email}"/>
	</div>
</div>
