		...
		<div id="menu-inside" class="row">
			<div class="columns col-sm-12 col-md-12 col-lg-12">
				<ul class="menu">
					...
					<li>
						<g:if test="${controllerName == 'usuario'}"><a href="/GA" class="ativado">
							<g:message code="main.menu.notification"></g:message></a></g:if>
						<g:else><a href="/GA">
							<g:message code="main.menu.notification"></g:message></a></g:else>
						<ul class="submenu">
							<li> <a href="/GA/usuario/create">
								<g:message code="main.menu.notification.addUser"></g:message></a></li>
							<li> <a href="/GA/usuario/index">
								<g:message code="main.menu.notification.listUser"></g:message></a></li>
						</ul>
					</li>
				</ul>
			</div>
