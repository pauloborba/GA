...
<html lang="en">
  <head>
    ...
    <title>
      ...
      <g:message code="jogador.atua.atualizar.title"></g:message>
    </title>
    <link rel="stylesheet" href="${resource(dir: 'stylesheets', file: 'jogador_cadastro.css')}"/>
  </head>
  <body>
        ...
        <div id="novocontrato" class="columns col-sm-12 col-md-12 col-lg-12">
          ...
          <form action="/GA/jogador/novo" method="POST">
            ...
            <div class="form-group row">
              ...
              <div class="col-xs-4">
                <input id="txt_cpf" type="text" name="txt_cpf" class="form-control"/>
              </div>
              <label for="txt_nascimento" class="col-xs-2 col-form-label">
                <g:message code="jogador.atributos.birthday"></g:message>:
              </label>
              <div class="col-xs-4">
                <input id="txt_nascimento" type="text" name="txt_nascimento" class="form-control"/>
              </div>
            </div>
            <div class="form-group row">
            ...
            <button type="submit" class="btn btn-primary">
              <g:message code="jogador.cadastrar.btnsubmit"></g:message>
            </button>
          </form>
        </div>
      </div>
